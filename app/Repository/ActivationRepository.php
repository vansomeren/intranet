...
/**
 * ActivationRepository which will handle activation codes in database.
 * Method getToken is taken from Illuminate/Auth/Passwords/DatabaseTokenRepository class.
 * Other methods will be used in ActivationService.
 */
